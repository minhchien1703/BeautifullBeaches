...
<html lang="en">
  ...
  <section class="section-destination">
    <div class="container">
      ...
      <h3>
        Welcome to the 2024 list of The <?php echo $data['zone']['zone_name']; ?>'s Best Beaches. Our 2024 list is a culmination of countless days spent by our judges, Beach Ambassadors and BeautyOfBeaches team exploring beaches all over the world. We hope this list provides the inspiration you need to plan your next beach vacation.
      </h3>
