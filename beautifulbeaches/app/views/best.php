...
<html lang="en">
  ...
  <section class="section-destination">
    <div class="container">
      ...
      <h3>
        Welcome to the 2024 list of The WORLD's Best Beaches. This is the list of all the beaches around the world with highest rating on our website from viewers.
      </h3>
          ...
          <?php foreach ($bests as $best): ?>
            <div class="l-5-6 m-12 c-12 gallery-item">
              ...
              <div class="slider-info">
                ...
                <a href="/beautifulbeaches/details/index?id=<?= $best['id'] ?>" class="slider-link">Details</a>
              </div>
            </div>
            <?php endforeach; ?>
