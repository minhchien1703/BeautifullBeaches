          ...
          <div class="aboutus">
            ...
            <div class="aboutus-item">
              ...
              <p class="aboutus-text">
                ...
                that through BeautyOfBeaches, we can inspire others
          ...
          <div class="advertise row">
            <div class="l-5 m-5 c-12">
              ...
              <div class="ad-media">
                ...
                <iframe width="470" height="250" src="https://www.youtube.com/embed/0ZBqnOeIxbQ?si=P9oFAgoC99nAuI-p&amp;start=958" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                <div class="ad-content">
                  <p>Eagle Beach - Aruba</p>
                </div>
              </div>
            </div>
            <div class="l-5 m-5 c-12">
              ...
              <div class="ad-media">
                ...
                <div class="ad">
                  <i class="fa-solid fa-question ad-icon"></i>
                  <a class="ad-link" href="https://www.vemaybay.vn/">Booking Airline Ticket</a>
                </div>
                <div class="ad">
                  <i class="fa-solid fa-question ad-icon"></i>
